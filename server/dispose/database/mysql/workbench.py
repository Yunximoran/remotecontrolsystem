try:
    ...
    from .tools.construction import Construction
    from .tools.formation import FormatPackage
    from .tools.check import Check
    from .err.log import LogManger
except ImportError:
    from dispose.database.mysql.basic.connector import Connector
    from dispose.database.mysql.basic.information import Information
    from dispose.database.mysql.tools.construction import Construction
    from dispose.database.mysql.tools.formation import FormatPackage
    from dispose.database.mysql.tools.check import Check
    from dispose.database.mysql.err.log import LogManger
